...
public class GenerateExpensesReportPdfUseCase : IGenerateExpensesReportPdfUseCase
{
    ...
    private Document CreateDocument(DateOnly month)
    {
        ...
        document.Info.Author = "Lucas Galhardo";
    ...
    private void CreateHeaderWithProfilePhotoAndName(Section page)
    {
        ...
        var directorName = Path.GetDirectoryName(assembly.Location);
        var pathFile = Path.Combine(directorName!, "Logo", "logo.png");
        row.Cells[0].AddImage(pathFile);

        row.Cells[1].AddParagraph("Olá, Lucas Galhardo");
    ...
    private void CreateTotalSpentSection(Section page, DateOnly month, decimal totalExpenses)
    {
        ...
        paragraph.AddFormattedText($"{CURRENCY_SYMBOL} {totalExpenses:0.00}", new Font { Name = FontHelper.WORKSANS_BLACK, Size = 50 });
    }
}
